document.addEventListener('DOMContentLoaded', function () {
    ...
    function loadMessages() {
        ...
        axios.get('https://messages-api.chillizu.workers.dev/api/messages')
            .then(response => {
    ...
    function deleteMessage(index, messageElem) {
        axios.delete(`https://messages-api.chillizu.workers.dev/api/messages/${index}`)
            .then(() => {
    ...
    messageForm.addEventListener('submit', function (event) {
        ...
        // 保存留言到后端 API
        axios.post('https://messages-api.chillizu.workers.dev/api/messages', {
            text: messageText,
            date: messageDate
        })
            .then(response => {
